...
export const communityController = {
    ...
    async listAll(req: AuthRequest, res: Response): Promise<void> {
        ...
        sendSuccess(res, HTTP_STATUS.OK, "Communities retrieved successfully", { communities: data });
    },
    ...
    async joinCommunity(req: AuthRequest, res: Response): Promise<void> {
        ...
        sendSuccess(res, HTTP_STATUS.OK, `Joined community ${community.name} successfully`);
    },
